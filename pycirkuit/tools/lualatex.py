...
class ToolLuaLaTeX(ExternalTool):
    # Class variable
    ID = "LUALATEX"

    def __init__(self):
        super().__init__(
            "lualatex", _translate("ExternalTool", "LuaLaTeX program", "Tool Long Name")
        )
    ...
    def execute(self, baseName):
        ...
        errMsg = _translate(
            "ExternalTool", "LuaLaTeX: Error converting TIKZ -> PDF", "Error message"
        )
        try:
