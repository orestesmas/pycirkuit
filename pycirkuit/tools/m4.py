...
class ToolM4(ExternalTool):
    def __init__(self):
        super().__init("m4", _translate("ExternalTool", "'M4' Macro Processor", "Tool Long Name"))
    ...
    def execute(self, src, dst):
        ...
        command = self.execName +" -I {cmPath} pgf.m4 {source} > {destination}".format(cmPath=cmPath, source=src, destination=dst)
