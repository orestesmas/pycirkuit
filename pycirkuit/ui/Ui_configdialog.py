...
class Ui_ConfigDialog(object):
    def setupUi(self, ConfigDialog):
        ...
        icon = QIcon()
        icon.addFile(
            ":/pixmaps/CfgGeneral", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        icon1 = QIcon()
        icon1.addFile(
            ":/pixmaps/CfgExportImage", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        self.verticalSpacer_5 = QSpacerItem(
            20, 5, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Maximum
        )

        self.verticalLayout_2.addItem(self.verticalSpacer_5)

        self.groupBox_latexEngine = QGroupBox(self.page1)
        self.groupBox_latexEngine.setObjectName("groupBox_latexEngine")
        ...
        self.horizontalLayout_latexEngine.setObjectName("horizontalLayout_latexEngine")
        self.latexEngine = QComboBox(self.groupBox_latexEngine)
        self.latexEngine.setObjectName("latexEngine")
        ...
        sizePolicy5.setHeightForWidth(
            self.labelQuality.sizePolicy().hasHeightForWidth()
        )
        ...
        self.verticalSpacer_2 = QSpacerItem(
            20, 5, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.MinimumExpanding
        )
    ...
    def retranslateUi(self, ConfigDialog):
        ConfigDialog.setWindowTitle(
            QCoreApplication.translate("ConfigDialog", "Config Dialog", None)
        )
        ...
        ___qlistwidgetitem.setText(
            QCoreApplication.translate("ConfigDialog", "General", None)
        )
        ___qlistwidgetitem1 = self.listWidget.item(1)
        ___qlistwidgetitem1.setText(
            QCoreApplication.translate("ConfigDialog", "Exporting", None)
        )
        self.listWidget.setSortingEnabled(__sortingEnabled)

        self.groupBox.setTitle(
            QCoreApplication.translate(
                "ConfigDialog", "Circuit Macros Location", "Group box title"
            )
        )
        self.cmPath.setPlaceholderText(
            QCoreApplication.translate("ConfigDialog", "Enter Path Name", None)
        )
        self.toolButtonCMPath.setText(
            QCoreApplication.translate("ConfigDialog", "Choose...", "Button text")
        )
        self.groupBox_latexEngine.setTitle(
            QCoreApplication.translate(
                "ConfigDialog", "LaTeX Engine", "Group box title"
            )
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate(
                "ConfigDialog", "LaTeX Template File", "Group box title"
            )
        )
        ...
        self.groupBox_vector.setTitle(
            QCoreApplication.translate(
                "ConfigDialog", "Image formats to export", "Group box title"
            )
        )
        ...
        self.exportTIKZ.setText(
            QCoreApplication.translate("ConfigDialog", "&TIKZ", None)
        )
        self.exportSVG.setText(QCoreApplication.translate("ConfigDialog", "SVG", None))
        self.exportPDF.setText(QCoreApplication.translate("ConfigDialog", "PD&F", None))
        self.exportPNG.setText(
            QCoreApplication.translate("ConfigDialog", "&PNG (raster)", None)
        )
        self.exportJPEG.setText(
            QCoreApplication.translate("ConfigDialog", "&JPEG (raster)", None)
        )
        ...
        self.labelDPI.setText(
            QCoreApplication.translate(
                "ConfigDialog", "Ras&ter image resolution in dots per inch (dpi):", None
            )
        )
        ...
        self.labelQuality.setText(
            QCoreApplication.translate(
                "ConfigDialog",
                "Image &quality for lossy formats like jpeg (percent):",
                None,
            )
        )
        self.exportQuality.setSuffix(
            QCoreApplication.translate("ConfigDialog", " %", "Spin box suffix")
        )
