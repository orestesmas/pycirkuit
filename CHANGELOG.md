...
## [1.1](https://github.com/orestesmas/pycirkuit/compare/v1.0.0..v1.1.0) series
<a name="1.1.0"></a>
### [1.1.0](https://github.com/orestesmas/pycirkuit/compare/v1.0.0..v1.1.0) : (2026-08-19)
#### Added
- Source editor: "Edit" menu with Undo/Redo/Cut/Copy/Paste, comment toggle, and a non-modal find/replace bar (Ctrl+F, Ctrl+H, F3/Shift+F3), each action with its own icon, tooltip and status bar text.
#### Changed
